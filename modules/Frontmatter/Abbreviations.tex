...
\abbr{CSD}{Current Source Density}{The rate at which the positive charge surplus of a small volume decreases, $-\dv*{\rho}{t}$. See \cref{sec:LFP}.}
...
\abbr{LFP}{Local field potential}{The extracellular electric potential (see \cref{sec:LFP}).}
