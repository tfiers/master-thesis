...
\notation{F_1}{F-score where recall and precision are weighted equally. For the common case where the $P R$-curve is concave, $F_1(T)$ is maximal when $P(T) = R(T)$ ($= F_1(T)$).}
