...
Sharp wave-ripples are a spatiotemporal pattern of the LFP of the \emph{hippocampus}. \Cref{fig:brain-anatomy} (left) shows the location of the hippocampus in the human and the rat brain.\footnotemark{} (The data analyzed in this thesis was recorded from a rat, which is why we focus on this animal).

\footnotetext{Strictly, a brain has two hippocampi, one in each hemisphere, mirrored with respect to each other. We will quite inconsistently refer to them in both singular and plural.}
