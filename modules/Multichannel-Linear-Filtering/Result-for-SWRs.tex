...
\captionn{Linear, SNR-maximising combinations of electrodes}{
  \panel{A} Example input and output signals.
    ...
    \Bottom: output envelopes $\n_t$, for different filtering algorithms. Dashed horizontal lines: detection thresholds, chosen so that each algorithm reaches a recall value of 80\%. Green triangles: correct detections. Red triangles: incorrect detections.
